...
export function Footer() {
  return (
    <footer className="bg-[#FF4900] text-white px-14 py-10 flex flex-col gap-5">
      <div className="flex items-center gap-2">
        <span className="inline-block h-4 w-4 rounded-full bg-[#242424]" />
      ...
      <div className="bg-[#242424] text-white py-5 px-10 rounded-md">
        Plansvel <b>@2024</b>
      </div>
    </footer>
  );
